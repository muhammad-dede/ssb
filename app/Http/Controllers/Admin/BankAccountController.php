...
class BankAccountController extends Controller
{
    ...
    {
        $this->checkPermission('admin.bank-account.index');
    ...
    {
        $this->checkPermission('admin.bank-account.create');

        return Inertia::render('admin/bank-account/Create', [
            'status_bank_accounts' => $this->status_bank_accounts,
            'banks' => $this->banks,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'status' => ['required', new Enum(StatusBankAccount::class)],
        ], [], $this->attributes);
        ...
        try {
            ...
            BankAccount::create([
                ...
                'status' => StatusBankAccount::from($request->status),
            ]);
            DB::commit();
            return redirect()->route('admin.bank-account.index')->with('success', 'Akun Bank berhasil ditambahkan');
        } catch (\Throwable $th) {
            DB::rollBack();
            throw $th;
        }
    ...
    {
        $this->checkPermission('admin.bank-account.edit');

        $bank_account = BankAccount::findOrFail($id);
        return Inertia::render('admin/bank-account/Edit', [
            'status_bank_accounts' => $this->status_bank_accounts,
            'banks' => $this->banks,
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('admin.bank-account.index')->with('success', 'Akun Bank berhasil diubah');
        } catch (\Throwable $th) {
            DB::rollBack();
            throw $th;
        }
    ...
    {
        $this->checkPermission('admin.bank-account.delete');
