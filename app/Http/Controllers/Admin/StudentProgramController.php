...
class StudentProgramController extends Controller
{
    ...
    {
        $this->checkPermission('admin.student-program.index');
    ...
    {
        $this->checkPermission('admin.student-program.create');

        return Inertia::render('admin/student-program/Create', [
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('admin.student-program.show', $student_program->id)->with('success', 'Registrasi Siswa berhasil ditambahkan');
        } catch (\Throwable $th) {
            DB::rollBack();
            throw $th;
        }
    ...
    {
        $this->checkPermission('admin.student-program.show');
    ...
    {
        $this->checkPermission('admin.student-program.edit');

        $student_program = StudentProgram::with(['billing'])->findOrFail($id);
        return Inertia::render('admin/student-program/Edit', [
            'students' => $this->students,
            'programs' => $this->programs,
            'periods' => $this->periods,
            'student_program' => $student_program,
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('admin.student-program.show', $student_program->id)->with('success', 'Registrasi Siswa berhasil diubah');
        } catch (\Throwable $th) {
            DB::rollBack();
            throw $th;
        }
    ...
    {
        $this->checkPermission('admin.student-program.delete');
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('admin.student-program.index')->with('success', 'Registrasi berhasil dihapus');
        } catch (\Throwable $th) {
            DB::rollBack();
            throw $th;
        }
    ...
    {
        $this->checkPermission('admin.student-program.payment');
