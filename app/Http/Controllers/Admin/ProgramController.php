...
class ProgramController extends Controller
{
    ...
    {
        $this->checkPermission('admin.program.index');
    ...
    {
        $this->checkPermission('admin.program.create');
    ...
    {
        $this->checkPermission('admin.program.edit');
    ...
    {
        $this->checkPermission('admin.program.delete');
