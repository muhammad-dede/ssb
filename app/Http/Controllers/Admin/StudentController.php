...
class StudentController extends Controller
{
    ...
    {
        $this->checkPermission('admin.student.index');
    ...
    {
        $this->checkPermission('admin.student.create');
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('admin.student.show', $student->id)->with('success', 'Siswa berhasil ditambahkan');
        } catch (\Throwable $th) {
            DB::rollBack();
            throw $th;
        }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('admin.student.show', $student->id)->with('success', 'Siswa berhasil diubah');
        } catch (\Throwable $th) {
            DB::rollBack();
            throw $th;
        }
    ...
    {
        $this->checkPermission('admin.student.delete');
