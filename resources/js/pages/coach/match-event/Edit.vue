...
const form = useForm({
    ...
    program_code: props.match_event.program_code ?? "",
    match_date: props.match_event.match_date ?? getDefaultDueDate(),
    ...
    our_score: props.match_event.our_score ?? 0,
    opponent_score: props.match_event.opponent_score ?? 0,
    location: props.match_event.location ?? "",
    description: props.match_event.description ?? "",
});

const submit = () => {
    form.patch(route("coach.match-event.update", props.match_event?.id), {
        preserveScroll: true,
    });
};
...
const breadcrumbs = [
    ...
    { title: "Ubah", href: "/coach/match-event/edit" },
];
</script>
                ...
                <Card>
                    ...
                    <CardFooter>
                        <div class="space-x-2">
                            ...
                            <Link
                                :href="route('coach.match-event.index')"
