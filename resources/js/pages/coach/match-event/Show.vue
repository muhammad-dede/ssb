...
const destroy = () => {
    ...
    router.delete(route("coach.match-event.destroy", props.match_event?.id), {
        preserveScroll: true,
    });
};
...
const generate = () => {
    ...
    router.post(
        route("coach.match-event.generate", props.match_event?.id),
        {},
        {
            preserveScroll: true,
            onFinish: () => {
...
const breadcrumbs = [
    ...
    { title: "Detail", href: "/coach/match-event/show" },
];
</script>
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                            <Link :href="route('coach.match-event.index')">
