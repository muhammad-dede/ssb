...
const form = useForm({
    ...
    program_code: props.training.program_code ?? "",
    training_date: props.training.training_date ?? getDefaultDueDate(),
...
const submit = () => {
    form.patch(route("coach.training.update", props.training?.id), {
        preserveScroll: true,
    });
};
...
const breadcrumbs = [
    ...
    { title: "Latihan", href: "/coach/training" },
    { title: "Ubah", href: "/coach/training/edit" },
];
</script>

<template>
    <Head title="Ubah Latihan" />
    <AppLayout :breadcrumbs="breadcrumbs">
        <MainContent>
            <HeadingGroup>
                <Heading
                    title="Ubah Latihan"
                    description="Formulir untuk mengubah data latihan yang telah terdaftar"
                />
            </HeadingGroup>
                ...
                <Card>
                    ...
                    <CardFooter>
                        <div class="space-x-2">
                            ...
                            <Link
                                :href="route('coach.training.index')"
