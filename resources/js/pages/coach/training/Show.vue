...
const destroy = () => {
    ...
    router.delete(route("coach.training.destroy", props.training?.id), {
        preserveScroll: true,
    });
};
...
const generate = () => {
    ...
    router.post(
        route("coach.training.generate", props.training?.id),
        {},
        {
            preserveScroll: true,
            onFinish: () => {
...
const breadcrumbs = [
    ...
    { title: "Detail", href: "/coach/training/show" },
];
</script>
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                            <Link :href="route('coach.training.index')">
                        ...
                        <DropdownMenuItem asChild>
                            <Link
                                :href="
                                    route('coach.training.edit', training.id)
                                "
                            >
                        ...
                        <DropdownMenuItem @select="showConfirmDelete = true">
