...
<template>
    <Alert class="mb-4">
        ...
        <AlertDescription>
            {{ coach.period_active?.name ?? "Tidak ada periode aktif" }}
        </AlertDescription>
    </Alert>
    <div class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-4">
            ...
            <CardContent class="relative">
                <div class="flex flex-col">
                    ...
                    <span class="text-2xl font-bold mb-3">
                        {{ coach.count_training_unregistered }}
                    </span>
                    <small class="text-xs"
                        >Total Siswa yang belum terdaftar dipelatihan</small
                    >
                    <div
        ...
        <Card>
            <CardContent class="relative">
                <div class="flex flex-col">
                    <h3 class="text-sm font-semibold mb-2">Siswa Latihan</h3>
                    <span class="text-2xl font-bold mb-3">
                        {{ coach.count_training_registered }}
                    </span>
                    <small class="text-xs"
                        >Total Siswa yang sudah terdaftar dipelatihan</small
                    >
                    <div
                        class="absolute right-0 h-full flex items-start justify-center px-6"
                    >
        ...
        <Card>
            <CardContent class="relative">
                <div class="flex flex-col">
                    <h3 class="text-sm font-semibold mb-2">
                        Siswa Belum Pertandingan
                    </h3>
                    <span class="text-2xl font-bold mb-3">
                        {{ coach.count_match_event_unregistered }}
                    </span>
                    <small class="text-xs"
                        >Total Siswa yang belum terdaftar dipertandingan</small
                    >
                    <div
                        class="absolute right-0 h-full flex items-start justify-center px-6"
                    >
        ...
        <Card>
            <CardContent class="relative">
                <div class="flex flex-col">
                    ...
                    <small class="text-xs"
                        >Total Siswa yang sudah terdaftar dipertandingan</small
                    >
                    <div
                        class="absolute right-0 h-full flex items-start justify-center px-6"
                    >
        ...
        <div>
            ...
            <div class="rounded-md border mb-4">
                <Table>
                    ...
                    <TableBody>
                        <template v-if="coach.training_schedules?.length > 0">
                            <TableRow
                                v-for="training in coach.training_schedules"
                                :key="training.id"
                            >
                                <TableCell>
        ...
        <div>
            ...
            <div class="rounded-md border mb-4">
                <Table>
                    ...
                    <TableBody>
                        <template
                            v-if="coach.match_event_schedules?.length > 0"
                        >
                            <TableRow
                                v-for="match_event in coach.match_event_schedules"
                                :key="match_event.id"
                            >
                                <TableCell>
