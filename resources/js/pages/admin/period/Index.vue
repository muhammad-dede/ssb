...
const destroy = () => {
    ...
    router.delete(route("admin.period.destroy", periodId), {
        preserveScroll: true,
        onFinish: () => {
...
const breadcrumbs = [
    ...
    { title: "Periode", href: "/admin/period" },
];
</script>
