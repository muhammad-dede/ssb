...
const destroy = () => {
    ...
    router.delete(route("admin.match-event.destroy", matchEventId), {
        preserveScroll: true,
        onFinish: () => {
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <MainContent>
            <HeadingGroup>
                ...
                />
                <Link
                    v-if="can('admin.match-event.create')"
                    :href="route('admin.match-event.create')"
                                    ...
                                    <DropdownMenu
                                        v-if="
                                            canAny(
                                                ...
                                                'admin.match-event.show',
                                                'admin.match-event.delete'
                                            )
                                        "
                                    >
