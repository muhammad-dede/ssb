...
const destroy = () => {
    ...
    router.delete(route("admin.bank-account.destroy", bankAccountId), {
        preserveScroll: true,
        onFinish: () => {
...
const breadcrumbs = [
    ...
    { title: "Akun Bank", href: "/admin/bank-account" },
];
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <MainContent>
            <HeadingGroup>
                ...
                />
                <Link
                    v-if="can('admin.bank-account.create')"
                    :href="route('admin.bank-account.create')"
