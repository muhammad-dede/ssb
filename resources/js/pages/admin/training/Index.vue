...
const destroy = () => {
    ...
    router.delete(route("admin.training.destroy", trainingId), {
        preserveScroll: true,
        onFinish: () => {
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <MainContent>
            <HeadingGroup>
                ...
                />
                <Link
                    v-if="can('admin.training.create')"
