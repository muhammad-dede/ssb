...
const destroy = () => {
    ...
    router.delete(route("admin.training.destroy", props.training?.id), {
        preserveScroll: true,
    });
};
...
const generate = () => {
    ...
    router.post(
        route("admin.training.generate", props.training?.id),
        {},
        {
            preserveScroll: true,
            onFinish: () => {
...
const breadcrumbs = [
    ...
    { title: "Latihan", href: "/admin/training" },
    { title: "Detail", href: "/admin/training/show" },
];
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <MainContent>
            <HeadingGroup>
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        <DropdownMenuItem
                            v-if="can('admin.training.index')"
                            asChild
                        >
                            <Link :href="route('admin.training.index')">
                                <Undo2 class="text-yellow-500" />
                                Kembali
                            </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem
                            v-if="can('admin.training.edit')"
                            asChild
                        >
                            <Link
                                :href="
                        ...
                        <DropdownMenuItem
                            v-if="can('admin.training.delete')"
            ...
            <Alert v-if="can('admin.training.generate')" class="mb-2 relative">
                <Bell class="h-4 w-4" />
