...
const dataControl = () => {
    router.get(
        route("admin.student-program.index"),
        {
...
const destroy = () => {
    ...
    router.delete(route("admin.student-program.destroy", studentProgramId), {
        preserveScroll: true,
        onFinish: () => {
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <MainContent>
            <HeadingGroup>
                ...
                />
                <Link
                    v-if="can('admin.student-program.create')"
                    :href="route('admin.student-program.create')"
                                    ...
                                    <DropdownMenu
                                        v-if="
                                            canAny(
                                                ...
                                                'admin.student-program.show',
                                                'admin.student-program.delete'
                                            )
                                        "
                                    >
