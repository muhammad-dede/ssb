...
const generatePdf = () => {
    ...
    const url = route("admin.report-student.pdf", id);
    window.open(url, "_blank");
};

const breadcrumbs = [
    { title: "Dashboard", href: "/dashboard" },
    { title: "Raport Siswa", href: "/admin/report-student" },
    { title: "Detail", href: "/admin/report-student/show" },
];
</script>
            ...
            <HeadingGroup>
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        <DropdownMenuItem
                            v-if="can('admin.report-student.index')"
                            asChild
                        >
                            <Link :href="route('admin.report-student.index')">
                                <Undo2 class="text-yellow-500" />
                                Kembali
                            </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem
                            v-if="can('admin.report-student.pdf')"
                            @click="generatePdf"
                        >
