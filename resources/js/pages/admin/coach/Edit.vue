...
const form = useForm({
    ...
    place_of_birth: props.coach.place_of_birth ?? "",
    date_of_birth: props.coach.date_of_birth ?? "",
    gender: props.coach.gender ?? "",
    address: props.coach.address ?? "",
    phone: props.coach.phone ?? "",
    national_id_number: props.coach.national_id_number ?? "",
    photo: null,
    coaching_license: props.coach.coaching_license ?? "",
    license_number: props.coach.license_number ?? "",
    license_issued_at: props.coach.license_issued_at ?? "",
    license_expired_at: props.coach.license_expired_at ?? "",
    license_issuer: props.coach.license_issuer ?? "",
...
onMounted(() => {
    if (props.coach.photo_url && !photoPreview.value) {
        photoPreview.value = props.coach.photo_url;
    }
});
...
const submit = () => {
    form.post(route("admin.coach.update", props.coach?.id), {
        forceFormData: true,
        preserveScroll: true,
    });
};
...
const breadcrumbs = [
    ...
    { title: "Pelatih", href: "/admin/coach" },
    { title: "Ubah", href: "/admin/coach/edit" },
];
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <MainContent>
            <HeadingGroup>
                <Heading
                    title="Ubah Pelatih"
                    description="Formulir untuk mengubah data pelatih yang telah terdaftar"
                />
            </HeadingGroup>
                ...
                <Card>
                    ...
                    <CardFooter>
                        <div class="space-x-2">
                            ...
                            <Link
                                v-if="can('admin.coach.show')"
                                :href="route('admin.coach.show', coach?.id)"
