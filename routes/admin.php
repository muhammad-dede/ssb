...
Route::middleware(['auth'])->prefix('admin')->as('admin.')->group(function () {
    ...
    Route::post('training/attendance', [App\Http\Controllers\Admin\TrainingController::class, 'attendance'])->name('training.attendance');
    Route::post('training/assessment', [App\Http\Controllers\Admin\TrainingController::class, 'assessment'])->name('training.assessment');
    ...
    Route::post('match-event/attendance', [App\Http\Controllers\Admin\MatchEventController::class, 'attendance'])->name('match-event.attendance');
    Route::post('match-event/assessment', [App\Http\Controllers\Admin\MatchEventController::class, 'assessment'])->name('match-event.assessment');
